...
type SchemaConfig struct {
	HubBusiness        string // HubBusiness table.
	HubCommunityReview string // HubCommunityReview table.
	HubCommunityWorker string // HubCommunityWorker table.
	HubEvent           string // HubEvent table.
	HubLock            string // HubLock table.
	HubPlaybook        string // HubPlaybook table.
	HubWorker          string // HubWorker table.
}
